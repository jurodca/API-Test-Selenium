...
public class StepsDefinitionsLoginTest
{
    ...
    {
        Thread.sleep(2000);
        driver.findElement(By.xpath("//*[@id='login_field']")).sendKeys("jrodriguezc@gmail.com");
    }
    ...
    {
        Thread.sleep(3000);
        driver.findElement(By.xpath("//*[@id='password']")).sendKeys("&Granuja426");
    }
    ...
    {
        Thread.sleep(3000);
        WebElement exploreGitHubButton =
