...
public class TCountryCodeAndNameGroupedByContinent implements java.io.Serializable
{
    ...
    public TCountryCodeAndNameGroupedByContinent(
    apitest.ws.TContinent continent, apitest.ws.TCountryCodeAndName[] countryCodeAndNames)
    {
    ...
    public synchronized boolean equals(java.lang.Object obj)
    {
        ...
        boolean _equals;
        _equals =
        true && ((this.continent == null && other.getContinent() == null) || (this.continent != null
        && this.continent.equals(other.getContinent()))) && ((this.countryCodeAndNames == null
        && other.getCountryCodeAndNames() == null) || (this.countryCodeAndNames != null
