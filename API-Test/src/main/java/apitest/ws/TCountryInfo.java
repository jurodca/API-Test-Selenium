...
public class TCountryInfo implements java.io.Serializable
{
    ...
    private apitest.ws.TLanguage[] languages;
    ...
    apitest.ws.TLanguage[] languages)
    {
     ...
     * @return languages
     */
    public apitest.ws.TLanguage[] getLanguages()
    {
        return languages;
    }
     ...
     * @param languages
     */
    public void setLanguages(apitest.ws.TLanguage[] languages)
    {
        this.languages = languages;
    }
    ...
    {
        if (!(obj instanceof TCountryInfo))
            return false;
        ...
        _equals =
        true
        && ((this.sISOCode == null && other.getSISOCode() == null) || (this.sISOCode != null
        && this.sISOCode.equals(other.getSISOCode())))
        && ((this.sName == null
        && other.getSName() == null) || (this.sName != null && this.sName.equals(other.getSName())))
        && ((this.sCapitalCity == null && other.getSCapitalCity() == null) || (this.sCapitalCity
        != null && this.sCapitalCity.equals(other.getSCapitalCity())))
        && ((this.sPhoneCode == null && other.getSPhoneCode() == null) || (this.sPhoneCode != null
        && this.sPhoneCode.equals(other.getSPhoneCode())))
        && ((this.sContinentCode == null && other.getSContinentCode() == null)
        || (this.sContinentCode != null && this.sContinentCode.equals(other.getSContinentCode())))
        ...
        && ((this.sCountryFlag == null && other.getSCountryFlag() == null) || (this.sCountryFlag
        != null && this.sCountryFlag.equals(other.getSCountryFlag())))
        && ((this.languages == null && other.getLanguages() == null) || (this.languages != null
