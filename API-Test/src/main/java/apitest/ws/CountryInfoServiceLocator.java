    ...
    apitest.ws.CountryInfoService
{
    ...
    private java.lang.String CountryInfoServiceSoap_address =
    ...
    throws javax.xml.rpc.ServiceException
    {
        try
        {
            apitest.ws.CountryInfoServiceSoapBindingStub _stub =
    ...
    throws javax.xml.rpc.ServiceException
    {
        try
        {
            if (apitest.ws.CountryInfoServiceSoapType.class
                .isAssignableFrom(serviceEndpointInterface))
            {
                apitest.ws.CountryInfoServiceSoapBindingStub _stub =
                    new apitest.ws.CountryInfoServiceSoapBindingStub(
                        new java.net.URL(CountryInfoServiceSoap_address),
                        this);
                _stub.setPortName(getCountryInfoServiceSoapWSDDServiceName());
                return _stub;
            }
